...
<title>마이페이지 회원정보 수정</title>
	...
	<!--제이쿼리 스크립트 경로 -->
	<script type="text/javascript" src="../js/user_page_infoUpdate.js?ver=24"></script>
...
<body>
	...
	<div class="menu userInfo">
		...
		<div>
			...
			<div style="margin-top: 50px;">
				...
				<button type="button" id="userDelBtnFrom">회원 탈퇴</button>
			</div>			
		</div>
	</div>
	...
	<div id="userDelDialog" title="회원삭제">
		<div align="center">
			<h5>삭제를 위해 밀번호를 입력해주세요</h5>
			비밀번호 : <input type="text" id="delPassword" >
			<input type="button" id="userDelBtn" value="확인">
		</div>
	</div>
